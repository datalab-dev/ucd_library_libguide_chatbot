...
async function sendMessage() {
  ...
  // LLM disclaimer shown immediately before any tokens arrive
  const disclaimerDiv = document.createElement("div");
  disclaimerDiv.innerHTML =
    `<strong>⚠️ This response is generated by AI.</strong><br>` +
    `<i>(As with all large language model output, use your own critical reading ` +
    `and thinking skills to assess the validity and reliability of this response ` +
    `for your specific query)</i><br><br>`;
  botDiv.appendChild(disclaimerDiv);
