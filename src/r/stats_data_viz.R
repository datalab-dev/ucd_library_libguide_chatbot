...
df_count <- get_basic_stats(df, chunk)
saveRDS(df_count, file = "/Users/sebrina/sts195/data/word_character_count.rds")


# create and save the box plots
word_box <- make_box(df_count, word_count, "Word Counts of Subsession Text")
character_box <- make_box(df_count, character_count, "Character Counts of Subsession Text")
...
summary_table(df_count, "character_count", "/Users/sebrina/sts195/character_count_summary.pdf")
summary_table(df_count, "word_count", "/Users/sebrina/sts195/word_count_summary.pdf")


# create and save the histogram plots
word_hist <- histogram(df_count, word_count, "Word Counts Bin by 25", "Word Counts")
character_hist <- histogram(df_count, character_count, "Character Counts Bin by 25", "Character Counts")
...
## Haven't test the above functions with actual data frame ##