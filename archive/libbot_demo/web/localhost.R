...
chatbot_handler <- function(env) {
  tryCatch({
    ...
    combined_response <- paste0(
      "<br><strong>This response is generated by AI.</strong><br><i>(As with all large language model output, use your own critical reading and thinking skills to assess the validity and reliability of this response for your specific query)</i><br><br>",
      llm_response,
